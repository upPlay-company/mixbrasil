        ...
        builder: (_, admManager, __){
          return Container(
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                title: Text('ANÚNCIE AGORA', style: TextStyle(color: Colors.black),),
                centerTitle: true,
                elevation: 0,
                backgroundColor: Colors.transparent,
              ...
              body: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text("Anúncio agora no Mix Brasil!",
                    ...
                    SizedBox(
                      ...
                      child: RaisedButton(
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(LineIcons.whatsapp, size: 30,),
                            SizedBox(width: 10,),
                            Text("Clique Aqui", style: TextStyle(fontSize: 22.0),),
                          ],
                        ),
                        textColor: Colors.white,
                        color: Color(0xff2dc64f),
                        onPressed: (){
                          launch("whatsapp://send?phone=${adm.whats}&text=Quero Anúnciar no MIX");
                        },
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        height: 54.0,
                        child: RaisedButton(
                          child: Text("Entrar", style: TextStyle(fontSize: 22.0),),
                          textColor: Colors.white,
